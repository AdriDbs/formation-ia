...
export function IconFlask(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M9 3h6M10 3v6l-5.5 9a1 1 0 0 0 .9 1.5h13.2a1 1 0 0 0 .9-1.5L14 9V3" />
      <path d="M7.5 15h9" />
    </svg>
  );
}
...
export function IconUsers(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M2.5 19c1.2-3.3 4-4.7 6.5-4.7s5.3 1.4 6.5 4.7" />
      <path d="M16 4.3c1.4.4 2.5 1.7 2.5 3.2 0 1.4-.9 2.6-2.1 3.1" />
